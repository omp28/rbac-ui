...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-4xl font-bold mb-8 text-gray-800">RBAC Dashboard</h1>
...
const DashboardCard = ({ title, count }) => (
  <div className="bg-white shadow-md rounded-lg p-6 transition-all duration-300 hover:shadow-xl border border-gray-200 hover:border-blue-500">
...
const ActivityItem = ({ text, time }) => (
  <li className="flex justify-between items-center bg-gray-50 p-3 rounded-md hover:bg-gray-100 transition-colors duration-200">
    <span>{text}</span>
